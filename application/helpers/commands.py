...
MENUS = {
    ...
    "Socials": [
        dict(evetn="open_url", label="Facebook", query="www.facebook.com"),
        dict(evetn="open_url", label="Instagram", query="www.instagram.com"),
        dict(evetn="open_url", label="Reddit", query="www.reddit.com"),
        dict(evetn="open_url", label="Twitter", query="www.twitter.com"),
        "---",
        dict(evetn="open_url", label="Telegram", query="web.telegram.org"),
        dict(evetn="open_url", label="Whatsapp", query="web.whatsapp.com"),
        dict(evetn="open_url", label="Discord", query="wwwdiscord.com/app"),
        dict(evetn="open_url", label="Slack", query="www.slack.com"),
        "---",
        dict(evetn="open_url", label="Tumblr", query="www.tumblr.com"),
        dict(evetn="open_url", label="Pinterest", query="www.pinterest.com"),
        dict(evetn="open_url", label="Linkedin", query="www.linkedin.com"),
    ],
}
