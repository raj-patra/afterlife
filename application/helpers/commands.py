...
STATUS_BAR_ACTIONS = [
    dict(event="start_app", icon="⚙", query="start ms-settings:"),
    dict(event="start_app", icon="🗨", query="start ms-actioncenter:"),
    dict(event="start_app", icon="📶", query="start ms-availablenetworks:"),
    dict(event="start_app", icon="🖥", query="start ms-settings-connectabledevices:devicediscovery"),
]
